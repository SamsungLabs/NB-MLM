...
fairseq-train $DATA_DIR --restore-file ../fairseq/roberta.${MODEL}/model.pt \
    ...
    --task temp_masked_lm --criterion masked_lm \
    --user-dir /home/narefyev/taskadapt/ROBERTA/temp_masked_lm \
    --arch roberta_${MODEL} --sample-break-mode $BREAK_MODE \
    ...
    --temperature ${TEMPERATURE} --path_to_scores ../FILIMDB_SCORES_${MIN_DF}/
